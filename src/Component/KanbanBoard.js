...
import eclipsgirl from "../assests/img/Ellipsegirl.png";
import eclipsblackgirl from "../assests/img/Ellipseblackgirl.png";
...
const initialData = {
  ...
  tasks: {
    ...
    "task-2": {
      ...
      eclipsgirl: eclipsgirl,
      eclipsblackgirl:eclipsblackgirl,
                    ...
                    return (
                      ...
                      >
                        {(provided) => (
                          ...
                          {index==0?(<div className={classes.cardtext}>
                            ...
                            </div>):index==1?(<div className={classes.cardtext}>
                              <div className={classes.cardheader}>
                                <section style={{color:'D8727d',background:'rgba(216,214,125,0.1'}}>{task.tag}</section>
                                <span>...</span>
                              </div>
                              ...
                              <div className={classes.todoavatar}>
                                ...
                                >
                                  <img src={task.eclipsblackgirl} alt="eclips12" />
                                </div>
                                <div
                                  style={{
                                    position: "absolute",
                                ...
                                >
                                  <img src={task.eclipsgirl} alt="eclips13" />
                                </div>
                            ...
                            </div>):(<div className={classes.cardtext}>
                              <div className={classes.cardheader}>
                                <section   style={{color:'D8727d',background:'rgba(216,214,125,0.1'}}>{task.tag}</section>
                                <span>...</span>
                              </div>
                              ...
                              <div className={classes.todoavatar}>
                                ...
                                >
                                  <img src={task.eclipsgirl} alt="eclips12" />
                                </div>
                                <div
                                   style={{
                                    position: "absolute",
                                ...
                                >
                                  <img src={task.eclipsblackgirl} alt="eclips13" />
                                </div>
                                <div
                                 style={{
                                    position: "absolute",
                                ...
                                >
                                  <img src={task.eclips13} alt="eclips15" />
                                </div>
                                <div className={classes.comments}>
                                  <img src={task.messageicon} alt="message" />
                                  <section>{task.comment}</section>
                      ...
                      >
                        {(provided) => (
                          <div
                            ...
                            {...provided.draggableProps}
                            {...provided.dragHandleProps}
                            // Use the task's color as a class name
                            //className={classes.card}
                          >
                           {index==0?( <div  className={classes.cardtextprogress}>
                              <div className={classes.cardheader}>
                                <section>{task.tag}</section>
                                <span>...</span>
                              </div>
                              ...
                              <h6>{task.title}</h6>
<div   className={classes.progressimg1}> 
<img src={task.column2img1} alt="column2img1" />
                              ...
                              <div className={classes.todoavatar}>
                                ...
                                <div className={classes.todofiles1}>
                                  <section   >{task.files}</section>
                                </div>
                              </div>
                            </div>): <div className={classes.cardtextprogress1} >
                              <div className={classes.cardheader}>
                                <section>{task.tag}</section>
                                <span>...</span>
                              </div>
                              ...
                              <h6>{task.title}</h6>
<div   className={classes.progressimg2}> 
<img src={task.column2img2} alt="column2img1" />
<img src={task.column2img3} alt="column2img1"  style={{marginLeft:'12px'}} />
</div>
                              ...
                              <div className={classes.todoavatar}>
                                ...
                                >
                                  <img src={task.eclips15} alt="eclips12" />
                                </div>
                      ...
                      >
                        {(provided) => (
                          <div
                            ...
                            //className={classes.card}
                          >
                            {index==0?(<div className={classes.cardtextdone}>
                              <div     className={classes.cardheader1}>
                                <section >{task.tag}</section>
                                <span>...</span>
                              </div>

                              <h6>{task.title}</h6>
                               <div  className={classes.donemainimg}>
                              ...
                              <div className={classes.todoavatar}>
                                ...
                                <div className={classes.todofilesdone}>
                                  <section>{task.files}</section>
                                </div>
                              </div>
                            </div>):( <div className={classes.cardtextdonecard}>
                              <div className={classes.cardheader1}>
                                <section>{task.tag}</section>
                                <span>...</span>
                              </div>
                              ...
                              <div className={classes.todoavatar}>
                                ...
                                >
                                  <img src={task.eclips15} alt="eclips13" />
                                </div>
                                <div
                                  style={{
                                    position: "absolute",
